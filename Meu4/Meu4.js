...
document.getElementById('second').addEventListener('click', function() {
    window.location.href = "/Sentimientos/Sentimiento-2/Sentimiento2.html";
});

document.getElementById('third').addEventListener('click', function() {
    window.location.href = "/Sentimientos/Sentimiento-3/Sentimiento3.html";
});

document.getElementById('fourth').addEventListener('click', function() {
    window.location.href = "/Sentimientos/Sentimiento-4/Sentimiento4.html";
});
